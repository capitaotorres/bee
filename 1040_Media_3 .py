#Programa Por Filipe Torres
#Ler 4 notas, apresentar as opções aprovado, recuperação e aprovado,
...
a descrição do problema. Não esqueça de imprimir o enter após o final de cada linha,
...
def texto():
    ...
    if media >= 7:
        ...
        novamedia = float(input(""))
        print(f"Nota do exame: {novamedia:.1f}")
        novamedia = (media + novamedia)/2
        if novamedia >= 5.0:
            print("Aluno aprovado.")
        else:
